...
class AboutStringManipulation(Koan):
    ...
    def test_strings_can_change_case(self):
        self.assertEqual('Guido', 'guido'.capitalize()) #first letter
        self.assertEqual('GUIDO', 'guido'.upper())  #all letters
        self.assertEqual('timbot', 'TimBot'.lower()) #all letters
        self.assertEqual('Guido Van Rossum', 'guido van rossum'.title()) #first of each word
        self.assertEqual('tOtAlLy AwEsOmE', 'ToTaLlY aWeSoMe'.swapcase()) #swap 'em all
